...
// Syncing provides information when this nodes starts synchronising with the Lemochain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  lemochain.SyncProgress `json:"status"`
}
