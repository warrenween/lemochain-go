...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (lemo/61) or header (lemo/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (lemo/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both lemo/61 and lemo/62)
}
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		default:
			// Somlemoing went very wrong, drop the peer
