...
// information related to the Lemochain protocol such als blocks, transactions and logs.
...
// It is part of the filter package since polling goes with lemo_getFilterChanges.
//
// https://github.com/lemochain/wiki/wiki/JSON-RPC#lemo_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(lemochain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// TODO(karalabe): Kill this in favor of lemochain.FilterQuery.
...
//
// https://github.com/lemochain/wiki/wiki/JSON-RPC#lemo_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(lemochain.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/lemochain/wiki/wiki/JSON-RPC#lemo_getlogs
...
//
// https://github.com/lemochain/wiki/wiki/JSON-RPC#lemo_uninstallfilter
...
//
// https://github.com/lemochain/wiki/wiki/JSON-RPC#lemo_getfilterlogs
...
//
// https://github.com/lemochain/wiki/wiki/JSON-RPC#lemo_getfilterchanges
