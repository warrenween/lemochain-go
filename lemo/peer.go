...
// PeerInfo represents a short summary of the Lemochain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Lemochain protocol version negotiated
...
// Handshake executes the lemo protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("lemo/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Lemochain sub-protocol.
type peerSet struct {
