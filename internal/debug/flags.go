...
import (
	...
	"github.com/LemoFoundationLtd/lemochain-go/log/term"
	"github.com/LemoFoundationLtd/lemochain-go/metrics"
	"github.com/LemoFoundationLtd/lemochain-go/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. lemo/*=5,p2p=4)",
		Value: "",
	}
