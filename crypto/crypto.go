...
// controls whlemoer the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whlemoer the signature values are valid with
