...
Go translates JavaScript-style regular expressions into somlemoing that is
...
difficult to provide somlemoing like these via Go, but you probably want to wrap
