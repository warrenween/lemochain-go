...
// Reference: https://github.com/lemochain/wiki/wiki/Lemohash-DAG
#define DAG_MUTABLE_NAME_MAX_SIZE (6 + 10 + 1 + 16 + 1)
/// Possible return values of @see lemohash_io_prepare
enum lemohash_io_rc {
...
/**
 * Logs a critical error in important parts of lemohash. Should mostly help
...
/**
 * Prepares io for lemohash
 *
 * Create the DAG directory and the DAG file if they don't exist.
 *
 * @param[in] dirname        A null terminated c-string of the path of the lemohash
 ...
 *                           https://github.com/lemochain/wiki/wiki/Lemohash-DAG
 ...
 *                           already exists
 * @return                   For possible return values @see enum lemohash_io_rc
 */
enum lemohash_io_rc lemohash_io_prepare(
	char const* dirname,
	lemohash_h256_t const seedhash,
	FILE** output_file,
	uint64_t file_size,
	bool force_create
);
 ...
 *
 * The spec defining this directory is here: https://github.com/lemochain/wiki/wiki/Lemohash-DAG
 *
...
static inline bool lemohash_io_mutable_name(
	uint32_t revision,
