...
// SetCtrlCAborts sets whlemoer Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whlemoer line is auto-wrapped. The default is false (single line).
...
// whlemoer to retry the call to, or return the error returned by, readNext.
