...
// Package glemo contains the simplified mobile APIs to lemochain-go.
//
// The scope of this package is *not* to allow writing a custom Lemochain client
// with pieces plucked from lemochain-go, rather to allow writing native dapps on
...
// from the lemochain-go repository. Please adhere to this scoping to prevent this
