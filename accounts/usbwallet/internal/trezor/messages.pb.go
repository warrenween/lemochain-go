...
const (
	...
	MessageType_MessageType_LemochainGetAddress       MessageType = 56
	MessageType_MessageType_LemochainAddress          MessageType = 57
	MessageType_MessageType_LemochainSignTx           MessageType = 58
	MessageType_MessageType_LemochainTxRequest        MessageType = 59
	MessageType_MessageType_LemochainTxAck            MessageType = 60
	...
	MessageType_MessageType_LemochainSignMessage      MessageType = 64
	MessageType_MessageType_LemochainVerifyMessage    MessageType = 65
	MessageType_MessageType_LemochainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_LemochainGetAddress",
	57:  "MessageType_LemochainAddress",
	58:  "MessageType_LemochainSignTx",
	59:  "MessageType_LemochainTxRequest",
	60:  "MessageType_LemochainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_LemochainSignMessage",
	65:  "MessageType_LemochainVerifyMessage",
	66:  "MessageType_LemochainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_LemochainGetAddress":       56,
	"MessageType_LemochainAddress":          57,
	"MessageType_LemochainSignTx":           58,
	"MessageType_LemochainTxRequest":        59,
	"MessageType_LemochainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_LemochainSignMessage":      64,
	"MessageType_LemochainVerifyMessage":    65,
	"MessageType_LemochainMessageSignature": 66,
...
// *
// Request: Ask device for Lemochain address corresponding to address_n path
// @next PassphraseRequest
// @next LemochainAddress
// @next Failure
type LemochainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *LemochainGetAddress) Reset()                    { *m = LemochainGetAddress{} }
func (m *LemochainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*LemochainGetAddress) ProtoMessage()               {}
func (*LemochainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *LemochainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LemochainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Lemochain address derived from device private seed
// @prev LemochainGetAddress
type LemochainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LemochainAddress) Reset()                    { *m = LemochainAddress{} }
func (m *LemochainAddress) String() string            { return proto.CompactTextString(m) }
func (*LemochainAddress) ProtoMessage()               {}
func (*LemochainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *LemochainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next LemochainTxRequest
// @next Failure
type LemochainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *LemochainSignTx) Reset()                    { *m = LemochainSignTx{} }
func (m *LemochainSignTx) String() string            { return proto.CompactTextString(m) }
func (*LemochainSignTx) ProtoMessage()               {}
func (*LemochainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *LemochainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LemochainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *LemochainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *LemochainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *LemochainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *LemochainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *LemochainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *LemochainSignTx) GetDataLength() uint32 {
...
func (m *LemochainSignTx) GetChainId() uint32 {
...
// @prev LemochainSignTx
// @next LemochainTxAck
type LemochainTxRequest struct {
...
func (m *LemochainTxRequest) Reset()                    { *m = LemochainTxRequest{} }
func (m *LemochainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*LemochainTxRequest) ProtoMessage()               {}
func (*LemochainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *LemochainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *LemochainTxRequest) GetSignatureV() uint32 {
...
func (m *LemochainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *LemochainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev LemochainTxRequest
// @next LemochainTxRequest
type LemochainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LemochainTxAck) Reset()                    { *m = LemochainTxAck{} }
func (m *LemochainTxAck) String() string            { return proto.CompactTextString(m) }
func (*LemochainTxAck) ProtoMessage()               {}
func (*LemochainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *LemochainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next LemochainMessageSignature
// @next Failure
type LemochainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *LemochainSignMessage) Reset()                    { *m = LemochainSignMessage{} }
func (m *LemochainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*LemochainSignMessage) ProtoMessage()               {}
func (*LemochainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *LemochainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LemochainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type LemochainVerifyMessage struct {
...
func (m *LemochainVerifyMessage) Reset()                    { *m = LemochainVerifyMessage{} }
func (m *LemochainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*LemochainVerifyMessage) ProtoMessage()               {}
func (*LemochainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *LemochainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *LemochainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *LemochainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev LemochainSignMessage
type LemochainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LemochainMessageSignature) Reset()                    { *m = LemochainMessageSignature{} }
func (m *LemochainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*LemochainMessageSignature) ProtoMessage()               {}
func (*LemochainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *LemochainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *LemochainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LemochainGetAddress)(nil), "LemochainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*LemochainAddress)(nil), "LemochainAddress")
	...
	proto.RegisterType((*LemochainSignTx)(nil), "LemochainSignTx")
	proto.RegisterType((*LemochainTxRequest)(nil), "LemochainTxRequest")
	proto.RegisterType((*LemochainTxAck)(nil), "LemochainTxAck")
	proto.RegisterType((*LemochainSignMessage)(nil), "LemochainSignMessage")
	proto.RegisterType((*LemochainVerifyMessage)(nil), "LemochainVerifyMessage")
	proto.RegisterType((*LemochainMessageSignature)(nil), "LemochainMessageSignature")
