...
// Status implements accounts.Wallet, returning whlemoer the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain lemochain.ChainStateReader) {}
