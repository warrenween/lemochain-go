...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/lemochain/pylemosaletool

		pylemosaletool generates the encryption key from password by
	...
	*/
	...
	lemoPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(lemoPriv)
	...
	expectedAddr := preSaleKeyStruct.LemoAddr
