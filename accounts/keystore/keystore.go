...
// See https://github.com/lemochain/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whlemoer the event notification loop is running
...
// ImportPreSaleKey decrypts the given Lemochain presale wallet and stores
