...
// Package bind generates Lemochain contract Go bindings.
//
// Detailed usage document and tutorial available on the lemochain-go Wiki page:
// https://github.com/LemoFoundationLtd/lemochain-go/wiki/Native-DApps:-Go-bindings-to-Lemochain-contracts
package bind
