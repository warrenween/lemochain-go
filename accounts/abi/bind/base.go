...
type CallOpts struct {
	Pending bool           // Whlemoer to operate on the pending state or the last known one
...
// valid Lemochain transaction.
type TransactOpts struct {
	From   common.Address // Lemochain account to send the transaction from
...
// DeployContract deploys a contract onto the Lemochain blockchain and binds the
...
func (c *BoundContract) Call(opts *CallOpts, result interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = lemochain.CallMsg{From: opts.From, To: &c.address, Data: input}
...
func (c *BoundContract) transact(opts *TransactOpts, contract *common.Address, input []byte) (*types.Transaction, error) {
	...
	if gasLimit == 0 {
		...
		msg := lemochain.CallMsg{From: opts.From, To: contract, Value: value, Data: input}
