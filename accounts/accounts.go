...
// Package accounts implements high level Lemochain account management.
package accounts
...
// Account represents an Lemochain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Lemochain account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain lemochain.ChainStateReader)
