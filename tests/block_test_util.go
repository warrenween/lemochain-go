...
// Package tests implements execution of Lemochain JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, nil, config, lemohash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/lemochain/tests/wiki/Blockchain-Tests-II

   Whlemoer a block is valid or not is a bit subtle, it's defined by presence of
