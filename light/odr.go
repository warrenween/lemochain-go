...
type OdrRequest interface {
	StoreResult(db lemodb.Database)
}
...
func (req *TrieRequest) StoreResult(db lemodb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db lemodb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db lemodb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db lemodb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db lemodb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db lemodb.Database) {
