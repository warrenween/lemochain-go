...
type GlogHandler struct {
	...
	override  uint32 // Flag whlemoer overrides are used, atomically accessible
	backtrace uint32 // Flag whlemoer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whlemoer this is the callsite
