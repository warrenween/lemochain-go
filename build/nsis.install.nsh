Name "glemo ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/LemoFoundationLtd/lemochain-go/issues"
!define UPDATEURL "https://github.com/LemoFoundationLtd/lemochain-go/releases"
!define ABOUTURL "https://github.com/LemoFoundationLtd/lemochain-go#lemochain-go"
...
# Install glemo binary
Section "Glemo" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Glemo}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\glemo.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\glemo.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Glemo incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Glemo outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Glemo UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Glemo incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\glemo.exe" "" "" "Lemochain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Glemo outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\glemo.exe" "" "" "Lemochain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Glemo UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\glemo.exe" "" "" "Lemochain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/lemochain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\glemo.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\glemo.ipc"
