...
# 1. install glemo for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for glemo
# 5. create glemo, attach and uninstall start menu entries
...
!define GROUPNAME "Lemochain"
!define APPNAME "Glemo"
!define DESCRIPTION "Official Go implementation of the Lemochain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since glemo is installed global
