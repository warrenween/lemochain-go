...
Please review the resulting diff to check whlemoer the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of lemochain-go authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The lemochain-go Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The lemochain-go library"
	}
	return "the lemochain-go library"
}
