...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllLemohashProtocolChanges, new: AllLemohashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllLemohashProtocolChanges, new: AllLemohashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllLemohashProtocolChanges,
