...
// that address/topic, and binary AND-ing those vectors toglemo.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them toglemo
				var orVector []byte
...
// the reuested retrieval queue to be serviced toglemo with other sessions.
//
