...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db lemodb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
	...
	genblock := func(i int, parent *types.Block, statedb *state.StateDB) (*types.Block, types.Receipts) {
		...
		// It's nonlemoeless ugly to spin up a blockchain here. Get rid of this somehow.
...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (lemodb.Database, *BlockChain, error) {
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db lemodb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db lemodb.Database, seed int) []*types.Block {
