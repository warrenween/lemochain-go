...
func (g *Genesis) ToBlock(db lemodb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db lemodb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db lemodb.Database) *types.Block {
...
func GenesisBlockForTesting(db lemodb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Lemochain main net genesis block.
...
// DeveloperGenesisBlock returns the 'glemo --dev' genesis block. Note, this must
// be seeded with the
