...
// account array.
func checkStateAccounts(t *testing.T, db lemodb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db lemodb.Database, root common.Hash) error {
...
func checkStateConsistency(db lemodb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(lemodb.Database), srcRoot)
