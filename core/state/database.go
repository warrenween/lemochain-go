...
// Trie is a Lemochain Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb lemodb.Putter) error
}
...
func NewDatabase(db lemodb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb lemodb.Putter) error {
