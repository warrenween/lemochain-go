...
// stateObject represents an Lemochain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of lemochain address of the account
	data     Account
	db       *StateDB
...
// Account is the Lemochain consensus representation of accounts.
