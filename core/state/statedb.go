...
// Package state provides a caching layer atop the Lemochain state trie.
package state
...
// StateDBs within the lemochain protocol are used to store anything
...
//
// Carrying over the balance ensures that Lemoer doesn't disappear.
