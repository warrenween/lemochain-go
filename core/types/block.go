...
// Package types contains data types related to Lemochain consensus.
package types
...
// Header represents a block header in the Lemochain blockchain.
type Header struct {
	...
	SignInfo    []byte         `json:"signature"        gencodec:"required"` // sman new
}
...
// a block's data contents (transactions and uncles) toglemo.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Lemochain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package lemo to track
...
// [deprecated by lemo/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for lemo protocol, etc.
...
// DecodeRLP decodes the Lemochain
...
// EncodeRLP serializes b into the Lemochain RLP block format.
