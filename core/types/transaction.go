...
var (
	...
	errNoSigner   = errors.New("missing signing mlemoods")
)
...
// Protected returns whlemoer the transaction is protected from replay protection.
...
//
// XXX Rename message to somlemoing less arbitrary?
