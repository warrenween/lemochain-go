...
func GetAllSortedCoreNodes() []AddrNodeIDMapping {
	...
	var pubKey = []byte(`8e88095f606e713bb52be8268ab7fe94f9656c0cf7a86d02dcaf141c7d54ed5ae9a3eaf69a2209a2fd645b33819df9ac46f4c251269671a847a7b01adf24b517`)
	result = append(result, AddrNodeIDMapping{addr, pubKey})

	addr = common.HexToAddress(`0xc848fe1d6b93c0ec640b3b2469c40378c8adbb5a`)
	pubKey = []byte(`0cfb8b4d451fe60b86e4c258632e05e44c044d29bce69a3148b7949ace4320804b95f313c4e9cb69c93861fdbee62177d0d30bda1663c2f580bb6bdd196b244b`)
	result = append(result, AddrNodeIDMapping{addr, pubKey})

	addr = common.HexToAddress(`0x8353a1ce6b1a77a6863de1e0a764a6f3e58d3b0b`)
	pubKey = []byte(`b25236b650906006dcb32f44aee565e54fb83026ce6a5d913ed7063a2a9e0c5b8e0a913b5755d6094fe36edaec73031a2f90f13992b6ae18c57520a8de094bfd`)
	result = append(result, AddrNodeIDMapping{addr, pubKey})
