...
func loadConfig(file string, cfg *glemoConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "lemo", "shh")
	cfg.WSModules = append(cfg.WSModules, "lemo", "shh")
	cfg.IPCPath = "glemo.ipc"
	return cfg
}
