...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Lemochain presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    glemo wallet import /path/to/my/presale.wallet

will prompt for your password and imports your lemoer presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Lemochain presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	glemo wallet [options] /path/to/my/presale.wallet
...
between lemochain nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    glemo account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    glemo account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another lemochain instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := glemoConfig{Node: defaultNodeConfig()}
	// Load config file.
