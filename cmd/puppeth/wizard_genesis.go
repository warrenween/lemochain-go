...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. Lemohash - proof-of-work")
	fmt.Println(" 2. Clique - proof-of-authority")

	choice := w.read()
	switch {
	case choice == "1":
		// In case of lemohash, we're pretty much done
		genesis.Config.Lemohash = new(params.LemohashConfig)
...
func (w *wizard) manageGenesis() {
	// Figure out whlemoer to modify or export the genesis
	fmt.Println()
