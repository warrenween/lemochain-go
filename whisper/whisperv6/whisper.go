...
// Whisper represents a dark communication interface through the Lemochain
...
// New creates a Whisper client ready to communicate through the Lemochain P2P network.
...
// param isP2P indicates whlemoer the message is peer-to-peer (should not be forwarded).
