...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "glemo.ipc", false, filepath.Join(os.TempDir(), "glemo.ipc")},
		{"data", "glemo.ipc", false, "data/glemo.ipc"},
		{"data", "./glemo.ipc", false, "./glemo.ipc"},
		{"data", "/glemo.ipc", false, "/glemo.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "glemo.ipc", true, `\\.\pipe\glemo.ipc`},
		{"data", "glemo.ipc", true, `\\.\pipe\glemo.ipc`},
		{"data", `\\.\pipe\glemo.ipc`, true, `\\.\pipe\glemo.ipc`},
	}
