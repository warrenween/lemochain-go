...
// DeployFIFSRegistrar deploys a new Lemochain contract, binding an instance of FIFSRegistrar to it.
...
// FIFSRegistrar is an auto generated Go binding around an Lemochain contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an Lemochain contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an Lemochain contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarFilterer is an auto generated log filtering Go binding around an Lemochain contract events.
type FIFSRegistrarFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an Lemochain contract,
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an Lemochain contract,
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an Lemochain contract,
