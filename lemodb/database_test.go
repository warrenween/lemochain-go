...
func newTestLDB() (*lemodb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "lemodb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := lemodb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db lemodb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db lemodb.Database, t *testing.T) {
	const n = 8
