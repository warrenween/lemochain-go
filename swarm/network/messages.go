...
import (
	...
	"github.com/LemoFoundationLtd/lemochain-go/swarm/network/kademlia"
	"github.com/LemoFoundationLtd/lemochain-go/swarm/services/swap"
...
Timeout serves to indicate whlemoer the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whlemoer responder is expected to deliver content
