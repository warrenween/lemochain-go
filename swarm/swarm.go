...
import (
	...
	"github.com/LemoFoundationLtd/lemochain-go/contracts/chequebook"
	"github.com/LemoFoundationLtd/lemochain-go/contracts/ens"
	...
	httpapi "github.com/LemoFoundationLtd/lemochain-go/swarm/api/http"
	"github.com/LemoFoundationLtd/lemochain-go/swarm/fuse"
	"github.com/LemoFoundationLtd/lemochain-go/swarm/network"
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := lemoclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := lemoclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
