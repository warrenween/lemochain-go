...
<html>
  <head>
    ...
    <meta name="description" content="Lemochain/Swarm Landing page">
    <meta property="og:url" content="https://swarm-gateways.net/bzz:/theswarm.lemo">
		<style>
  ...
  <body>
      ...
      <footer>
        <p>
          ...
          <a href="http://swarm-gateways.net/bzz:/theswarm.lemo">Swarm</a>
        </p>
      </footer>
