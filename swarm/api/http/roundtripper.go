...
see https://github.com/LemoFoundationLtd/lemochain-go/issues/2040
Usage:

import (
 "github.com/LemoFoundationLtd/lemochain-go/common/httpclient"
 "github.com/LemoFoundationLtd/lemochain-go/swarm/api/http"
)
