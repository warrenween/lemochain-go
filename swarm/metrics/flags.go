...
import (
	...
	glemometrics "github.com/LemoFoundationLtd/lemochain-go/metrics"
	"github.com/LemoFoundationLtd/lemochain-go/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if glemometrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(glemometrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
