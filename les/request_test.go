...
type accessTestFn func(db lemodb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db lemodb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db lemodb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db lemodb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db lemodb.Database, bhash common.Hash, number uint64) light.OdrRequest {
