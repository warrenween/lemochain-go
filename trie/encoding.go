...
// 'terminator' byte of value 0x10 which indicates whlemoer or not the node at the key
...
// the second-lowest encoding whlemoer the node at the key is a value node. The low nibble
...
// hasTerm returns whlemoer a hex key has the terminator flag.
