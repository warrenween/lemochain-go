...
creating a collection of devp2p nodes, connecting them toglemoer to form a
...
connecting two nodes toglemoer).

This is in contrast to a non-control event, otherwise called a "live" event,
which is the outcome of somlemoing happening in the network as a result of a
...
As a concrete example, consider a simulated network of Lemochain nodes. An
