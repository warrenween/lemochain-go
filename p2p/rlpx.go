...
import (
	...
	"github.com/LemoFoundationLtd/lemochain-go/crypto/ecies"
	"github.com/LemoFoundationLtd/lemochain-go/crypto/secp256k1"
...
// and also verifies whlemoer the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whlemoer read packet had plain format.
